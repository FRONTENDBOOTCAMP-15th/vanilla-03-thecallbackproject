...
필수 기능을 먼저 안정적으로 완성하고, 선택 기능들도 하나씩 시도해 보면서  
자연스럽게 확장되는 구조를 목표로 했습니다.
<br>
<br>
...
### 🖋️ 글 쓰기 페이지
<table>
<tr><td><b>네비게이션 탭 바</b></td><td style="color:#777;">독립된 화면처럼 보이도록 네비게이션 탭 바 미노출</td></tr>
<tr><td><b>페이지 접속 시 로그인 여부 검사</b></td><td style="color:#777;">로컬스토리지의 유저 정보(토큰 유무) 확인</td></tr>
<tr><td><b>입력 필드 유효성 검사</b></td><td style="color:#777;">토스트 메시지로 안내</td></tr>
<tr><td><b>폼 중복 제출 방지</b></td><td style="color:#777;">중복 submit 방지 로직 사용</td></tr>
<tr><td><b>태그 입력 기능</b></td><td style="color:#777;">생성된 태그는 상세페이지에서 표시</td></tr>
<tr><td><b>본문 텍스트 정렬 기능</b></td><td style="color:#777;">왼쪽, 가운데, 오른쪽</td></tr>
<tr><td><b>이미지 파일 첨부 기능</b></td><td style="color:#777;">미리보기, 용량 표시, 첨부 취소 기능</td></tr>
<tr><td><b>가상 키보드</b></td><td style="color:#777;">툴바 위치 이동 및 키보드 숨김 기능</td></tr>
</table>
